...
const PARAMS = {
  ...
  DASH_MULT_MIN: 6, // 대시 시작 배수
  DASH_MULT_RANGE: 0, // 추가 대시 배수
  DASH_DECAY: 0.97, // 대시 감쇠율
...
export function applyHomeGroupKrill(groupIds, animalsRef, _rect) {
...
export default {
  ...
  homeInit: initHomeKrill,
  homeGroup: applyHomeGroupKrill,
};
